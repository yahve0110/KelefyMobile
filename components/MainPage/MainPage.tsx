  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.carouselWrapper}>
        <View style={styles.carouselContainer}>
          ...
          <TouchableOpacity
            style={[
              styles.arrowButton,
              styles.rightArrow,
              { opacity: activeIndex === levels.length - 1 ? 0.3 : 1 },
            ]}
            onPress={() => scrollToIndex(activeIndex + 1)}
        ...
        {/* Индикаторы теперь внутри carouselWrapper */}
...
const styles = StyleSheet.create({
  ...
  carouselWrapper: {
    height: windowHeight * 0.7, // 70% высоты экрана для всего компонента
    justifyContent: "center",
  },
  carouselContainer: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "center",
    height: windowHeight * 0.6, // 60% высоты экрана для карточек
  },
  scrollContent: {
    paddingHorizontal:
      (Dimensions.get("window").width - Dimensions.get("window").width * 0.7) /
      2,
    alignItems: "center",
  },
  arrowButton: {
  ...
  levelButton: {
    height: windowHeight * 0.6, // 60% высоты экрана
    backgroundColor: Colors.light.secondaryBackground,
    borderRadius: 15,
    justifyContent: "center",
    alignItems: "center",
  ...
  indicators: {
    ...
    justifyContent: "center",
    alignItems: "center",
    marginTop: 10, // Уменьшили отступ сверху
    height: 20, // Фиксированная высота для индикаторов
  },
  indicator: {
    height: 10,
    borderRadius: 5,
